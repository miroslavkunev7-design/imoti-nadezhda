...
export const FALLBACK_CITIES: City[] = [
  {
    ...
    slug: 'shumen',
    description:
      'Шумен е историческият град с богато културно наследство и отлична инфраструктура. Предлага разнообразие от имоти — от модерни апартаменти в центъра до къщи с просторни дворове в тихи квартали.',
